...
public class JwtUtil {
    ...
    public boolean isVerify(String jwtToken) {
        ...
        switch (signatureAlgorithm) {
            case HS256:
                algorithm = Algorithm.HMAC256(Base64.getDecoder().decode(base64EncodedSecretKey));
                break;
            case HS512:
                algorithm = Algorithm.HMAC512(Base64.getDecoder().decode(base64EncodedSecretKey));
                break;
            default:
